  ...
  return (
    <>
      <form class="">
          ...
          <div class="form-group">
              <label for="exampleInputPassword1" class="m-2"> Major </label>
              <input type="text" class="form-control w-auto m-2" id="exampleInputPassword1" placeholder="Major"/>
          </div>
          <div class="form-group">
              <label for="exampleInputPassword1" class="m-2"> School </label>
              <input type="text" class="form-control m-2 w-auto" id="exampleInputPassword1" placeholder="School"/>
          </div>
          <div class="form-group">
              <label for="exampleInputPassword1" class="m-2"> Availability </label> <br/>
