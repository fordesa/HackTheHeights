  ...
  return (
    <>
      <form className="">
          ...
          <div className="form-group">
              <label for="exampleInputPassword1" className="m-2"> Major </label>
              <input type="text" className="form-control w-auto m-2" id="exampleInputPassword1" placeholder="Major"/>
          </div>
          <div className="form-group">
              <label for="exampleInputPassword1" className="m-2"> School </label>
              <input type="text" className="form-control m-2 w-auto" id="exampleInputPassword1" placeholder="School"/>
          </div>
          <div className="form-group">
              <label for="exampleInputPassword1" className="m-2"> Availability </label> <br/>
